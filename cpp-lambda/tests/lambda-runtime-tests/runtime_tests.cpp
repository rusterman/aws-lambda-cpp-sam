...
namespace {
    ...
    constexpr auto REQUEST_TIMEOUT = 50 * 1000;
    ...
    struct LambdaRuntimeTest : public ::testing::Test {
        ...
        static Aws::Client::ClientConfiguration create_iam_config()
        {
            ...
            config.connectTimeoutMs = 50 * 1000;
        ...
        {
            // Clean up functions
            delete_function(build_resource_name("echo_success"), false);
            delete_function(build_resource_name("echo_failure"), false);
            delete_function(build_resource_name("binary_response"), false);
            delete_function(build_resource_name("crash_backtrace"), false);
        }
        ...
        void create_function(Aws::String const& function_name, Aws::String const& handler_name)
        {
            ...
            std::cout << "Function created: " << function_name << std::endl;
        ...
        void delete_function(Aws::String const& function_name, bool assert = true)
        {
            ...
            std::cout << "Function deleted: " << function_name << std::endl;
        }
    };
    ...
    TEST_F(LambdaRuntimeTest, echo_success)
    {
        ...
        create_function(funcname, "echo_success");
    ...
    TEST_F(LambdaRuntimeTest, echo_failure)
    {
        ...
        create_function(funcname, "echo_failure");
        Model::InvokeRequest invoke_request;
        invoke_request.SetFunctionName(funcname);
        invoke_request.SetInvocationType(Model::InvocationType::RequestResponse);
    ...
    TEST_F(LambdaRuntimeTest, binary_response)
    {
        ...
        create_function(funcname, "binary_response");
        Model::InvokeRequest invoke_request;
        invoke_request.SetFunctionName(funcname);
        invoke_request.SetInvocationType(Model::InvocationType::RequestResponse);
    ...
    TEST_F(LambdaRuntimeTest, crash)
    {
        ...
        create_function(funcname, "crash_backtrace");
        Model::InvokeRequest invoke_request;
        invoke_request.SetFunctionName(funcname);
        invoke_request.SetInvocationType(Model::InvocationType::RequestResponse);
